...
results_folder_name = "my_results_test"
...
fig_3b = scatter_4way(scatter_data, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 80, 21, 0.5, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol Radiative Forcing Scale Factor", "Equilibirium Climate Sensitivity (C)", c("Ocean Heat \n Diffusivity", "Carbon Sink Respiration \n Temperature Sensitivity"), c(6,2,3,3), FALSE, "", "", TRUE, TRUE)
fig_3c = scatter_4way(scatter_data, c("ECS", "dice", "Q10_size", "aerosol"), 80, 23, 0.5, c("yellow", "red", "blue"), c(0.6, 1.5), c(0.6,1.5), c("< 0.6", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3500), c(0,1000,2000,3000), c("0","1000","2000","3000"), "Equilibirium Climate Sensitivity (C)", "Social Cost of Methane ($/t-CH4)", c("Aerosol Forcing \n Scale Factor", "Carbon Sink Respiration \n Temperature Sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, TRUE, TRUE)
...
fig_4a_main = spaghetti_single(temperature_response, temperature_response_CI, "#efab23", 0.15, c(1765, 2300), 2020, 80, c(0,6.5e-11), c(0,2e-11,4e-11,6e-11), c("0", "2e-11", "4e-11", "6e-11"), "Year", "Temperature Response (C/t-CH4)", c(2010,2160), c(2020, 2060, 2100, 2140), c("2020", "2060", "2100", "2140"))
...
fig_4b_main = spaghetti_multi(dice_damages_25, dice_damages_30, dice_damages_50, dice_damages_70, dice_damages_mean, impulse_colors, impulse_alphas, c(2010, 2300), 2020, 80, c(-10,65), c(0, 30, 60), c("0", "30", "60"), "Year", "Damage Response ($/t-CH4)", c(2015,2160), c(2020,2060,2100,2140), c("2020","2060","2100","2140"))
fig_4c_main = spaghetti_multi(fund_damages_25, fund_damages_30, fund_damages_50, fund_damages_70, fund_damages_mean, impulse_colors, impulse_alphas, c(1950, 2300), 2020, 80, c(-10,65), c(0, 30, 60), c("0", "30", "60"), "Year", "Damage Response ($/t-CH4)", c(2015,2160), c(2020,2060,2100,2140), c("2020","2060","2100","2140"))
...
axis_5c_settings = list(x_lim=c(-450,14000), x_breaks=seq(0,13500,by=3000), x_labels=c("0", "3,000", "6,000", "9,000", "12,000"), x_title="Equity-Weighted Social Cost of Methane ($/t-CH4)",
				        y_lim=c(0,0.00165), y_breaks=c(0,0.0005,0.001, 0.0015), y_labels=c("0","0.0005","0.001", "0.0015"), y_title="Density")
...
extended_fig_4b = ch4cycle_scatter(scatter_data_ch4cycle, c("natural_emiss", "lifetime"), 80, 21, 1.0, "mediumorchid1", 0.8, 1,1, "1", c(175,320), c(180, 220, 260, 300), c("180", "220", "260", "300"), c(6.6,9.1), c(7,8,9), c("7","8","9"), "Natural methane emissions (Mt/yr)", "Initial tropospheric methane lifetime (years)", "N/A", c(6,2,3,3), TRUE, 2, FALSE, "", "", "")

# Create scatter plot between methane cycle parameters and SC-CH4.
extended_fig_4c = ch4cycle_scatter(scatter_data_ch4cycle, c("natural_emiss", "dice", "lifetime"), 80, 23, 1.0, "dodgerblue1", "", c(0.2,3.8), c(7,7.5,8,8.5), c("7", "7.5", "8", "8.5"), c(175,320), c(180, 220, 260, 300), c("180", "220", "260", "300"), c(0,3600), c(0,1000,2000,3000), c("0","1,000","2,000","3,000"), "Natural methane emissions (Mt/yr)", "Social cost of methane ($/t-CH4)", c("Initial tropospheric \nmethane lifetime (years)"), c(6,2,3,3), FALSE, "", TRUE, c("natural_emiss", "fund", "lifetime"), 21, "indianred1")
...
extended_fig_5a = scatter_4way(scatter_data_fairch4, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 80, 21, 0.8, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol radiative forcing scale factor", "Equilibirium climate sensitivity (C)", c("Ocean heat \ndiffusivity", "Carbon sink respiration \ntemperature sensitivity"), c(6,2,3,3), FALSE, "", "", FALSE, TRUE)
extended_fig_5d = scatter_4way(scatter_data_fairch4, c("ECS", "dice", "Q10_size", "aerosol"), 80, 23, 0.9, c("yellow", "red", "blue"), c(0.6, 1.5), c(0.6,1.5), c("< 0.5", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3600), c(0,1000,2000,3000), c("0","1,000","2,000","3,000"), "Equilibirium climate sensitivity (C)", "Social cost of methane ($/t-CH4)", c("Aerosol forcing \nscale factor", "Carbon sink respiration \ntemperature sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, FALSE, TRUE)
...
extended_fig_5b = scatter_4way(scatter_data_fundch4, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 80, 21, 0.8, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol radiative forcing scale factor", "Equilibirium climate sensitivity (C)", c("Ocean heat \ndiffusivity", "Carbon sink respiration \ntemperature sensitivity"), c(6,2,3,3), FALSE, "", "", FALSE, TRUE)
extended_fig_5e = scatter_4way(scatter_data_fundch4, c("ECS", "dice", "Q10_size", "aerosol"), 80, 23, 0.9, c("yellow", "red", "blue"),c(0.6, 1.5), c(0.6,1.5), c("< 0.5", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3600), c(0,1000,2000,3000), c("0","1,000","2,000","3,000"), "Equilibirium climate sensitivity (C)", "Social cost of methane ($/t-CH4)", c("Aerosol forcing \nscale factor", "Carbon sink respiration \ntemperature sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, FALSE, TRUE)
...
extended_fig_5c = scatter_4way(scatter_data_hectorch4, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 80, 21, 0.8, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol radiative forcing scale factor", "Equilibirium climate sensitivity (C)", c("Ocean heat \ndiffusivity", "Carbon sink respiration \ntemperature sensitivity"), c(6,2,3,3), FALSE, "", "", TRUE, TRUE)
extended_fig_5f = scatter_4way(scatter_data_hectorch4, c("ECS", "dice", "Q10_size", "aerosol"), 80, 23, 0.9, c("yellow", "red", "blue"), c(0.6, 1.5), c(0.6,1.5), c("< 0.5", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3600), c(0,1000,2000,3000), c("0","1,000","2,000","3,000"), "Equilibirium climate sensitivity (C)", "Social cost of methane ($/t-CH4)", c("Aerosol forcing \nscale factor", "Carbon sink respiration \ntemperature sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, TRUE, TRUE)
...
us_ecs_sample = data.frame(us_ecs = 1.2 / (1 - rtnorm(80, 00.6198, 0.1841, -0.2, 0.88)))
...
extended_fig_7b = us_ecs_scatter(dice_fairch4_data, fund_fairch4_data, 0.12, 1.5, 80, c(0,5800), c(0,10.1), expression(paste("Equilibrium Climate Sensitvity ("*degree*C*")")), "Social Cost of Methane ($/t-CH4)", FALSE, TRUE, "S-FAIR", c(0.4, 5600), c(0.3,0.3,0.3,0.3))
extended_fig_7c = us_ecs_scatter(dice_fundch4_data, fund_fundch4_data, 0.12, 1.5, 80, c(0,5800), c(0,10.1), expression(paste("Equilibrium Climate Sensitvity ("*degree*C*")")), "Social Cost of Methane ($/t-CH4)", FALSE, FALSE, "S-FUND", c(0.4, 5600), c(0.3,0.3,0.3,0.3))
extended_fig_7d = us_ecs_scatter(dice_hectorch4_data, fund_hectorch4_data, 0.12, 1.5, 80, c(0,5800), c(0,10.1), expression(paste("Equilibrium Climate Sensitvity ("*degree*C*")", sep="")), "Social Cost of Methane ($/t-CH4)", TRUE, TRUE, "S-Hector", c(0.4, 5600), c(0.3,0.3,0.3,0.3))
extended_fig_7e = us_ecs_scatter(dice_magiccch4_data, fund_magiccch4_data, 0.12, 1.5, 80, c(0,5800), c(0,10.1), expression(paste("Equilibrium Climate Sensitvity ("*degree*C*")")), "Social Cost of Methane ($/t-CH4)", TRUE, FALSE, "S-MAGICC", c(0.4, 5600), c(0.3,0.3,0.3,0.3))
