...
function construct_run_mimi_sneasy()
    m = getsneasy_hector(start_year=1765, end_year=2017)
    ...
    function run_mimi_sneasy!(
        ...
        setparameter(m, :ohcyclehector, :TOH0, TOH0)
        setparameter(m, :ohcyclehector, :M0, CH4_0)

        setparameter(m, :rfch4hector, :CH4_0, CH4_0)
        setparameter(m, :rfch4hector, :N₂O_0, N2O_0)
        setparameter(m, :rfch4hector, :scale_CH₄, rf_scale_CH₄)

        setparameter(m, :rfco2, :CO₂_0, CO2_0)
        setparameter(m, :rfco2, :N₂O_0, N2O_0)
        setparameter(m, :rfco2, :scale_CO₂, scale_CO₂)

        setparameter(m, :ch4cyclehector, :M0, CH4_0)
        setparameter(m, :ch4cyclehector, :CH4N, CH4_Nat)
        setparameter(m, :ch4cyclehector, :Tsoil, Tsoil)
        setparameter(m, :ch4cyclehector, :Tstrat, Tstrat)

        setparameter(m, :rfch4h2ohector, :M0, CH4_0)
        ...
        model_ch4[:] = m[:ch4cyclehector, :CH4]
