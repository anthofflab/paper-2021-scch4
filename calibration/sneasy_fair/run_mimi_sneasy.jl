# Run version of Mimi sneasy without the natural emissions scenario
#include("../../src/sneasy_fair/sneasy_fair.jl")
include("../../src/sneasy_fair/sneasy_fair_no_natural.jl")

function construct_run_mimi_sneasy()
    m = getsneasy_fair(start_year=1765, end_year=2017)
    ...
    function run_mimi_sneasy!(
        ...
        setparameter(m, :rfch4fair, :CH₄_0, CH4_0)
        setparameter(m, :rfch4fair, :N₂O_0, N2O_0)
        setparameter(m, :rfch4fair, :scale_CH₄, rf_scale_CH₄)
        ...
        setparameter(m, :ch4cycle_fair, :τ, τ)
        setparameter(m, :ch4cycle_fair, :CH₄_0, CH4_0)  #Pre-industrial CH4 concentrations (value for 1765 from RCP8.5 concnetration data)
        setparameter(m, :ch4cycle_fair, :constant_natural_CH₄, CH4_Nat)

        setparameter(m, :fair_trop_o3, :CH₄_0, CH4_0)
