...
# Create a function that will run SNEASY-FAIR and return required model output.
function construct_run_sneasy_fairch4(calibration_end_year::Int)

    # Load an instance of SNEASY-FAIR (with option of how many years to calibrate model for).
