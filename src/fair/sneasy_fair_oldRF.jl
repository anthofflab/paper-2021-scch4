...
# NOTE THIS USES THE NO NATURAL CH₄ EMISSION SCENARIO VERSION OF THE MODEL.
include("ch4cycle_fair_no_changing_natural.jl")
include("rfch4_fair_old.jl")
...
function getsneasy_fair(;rcp_scenario="RCP85", start_year = 1765, end_year = 2300)
    ...
    setparameter(m, :rfch4fair, :H₂O_share, 0.15)  
