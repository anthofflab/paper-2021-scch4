...
fig_3b = scatter_4way(scatter_data, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 5000, 21, 0.5, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol Radiative Forcing Scale Factor", "Equilibirium Climate Sensitivity (C)", c("Ocean Heat \n Diffusivity", "Carbon Sink Respiration \n Temperature Sensitivity"), c(6,2,3,3), FALSE, "", "", TRUE, TRUE)
fig_3c = scatter_4way(scatter_data, c("ECS", "dice", "Q10_size", "aerosol"), 5000, 23, 0.5, c("yellow", "red", "blue"), c(0.6, 1.5), c(0.6,1.5), c("< 0.6", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3500), c(0,1000,2000,3000), c("0","1000","2000","3000"), "Equilibirium Climate Sensitivity (C)", "Social Cost of Methane ($/t-CH4)", c("Aerosol Forcing \n Scale Factor", "Carbon Sink Respiration \n Temperature Sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, TRUE, TRUE)
...
extended_fig_5a = scatter_4way(scatter_data_fairch4, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 5000, 21, 0.8, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol radiative forcing scale factor", "Equilibirium climate sensitivity (C)", c("Ocean heat \ndiffusivity", "Carbon sink respiration \ntemperature sensitivity"), c(6,2,3,3), FALSE, "", "", FALSE, TRUE)
extended_fig_5d = scatter_4way(scatter_data_fairch4, c("ECS", "dice", "Q10_size", "aerosol"), 5000, 23, 0.9, c("yellow", "red", "blue"), c(0.6, 1.5), c(0.6,1.5), c("< 0.5", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3600), c(0,1000,2000,3000), c("0","1,000","2,000","3,000"), "Equilibirium climate sensitivity (C)", "Social cost of methane ($/t-CH4)", c("Aerosol forcing \nscale factor", "Carbon sink respiration \ntemperature sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, FALSE, TRUE)
...
extended_fig_5b = scatter_4way(scatter_data_fundch4, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 5000, 21, 0.8, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol radiative forcing scale factor", "Equilibirium climate sensitivity (C)", c("Ocean heat \ndiffusivity", "Carbon sink respiration \ntemperature sensitivity"), c(6,2,3,3), FALSE, "", "", FALSE, TRUE)
extended_fig_5e = scatter_4way(scatter_data_fundch4, c("ECS", "dice", "Q10_size", "aerosol"), 5000, 23, 0.9, c("yellow", "red", "blue"),c(0.6, 1.5), c(0.6,1.5), c("< 0.5", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3600), c(0,1000,2000,3000), c("0","1,000","2,000","3,000"), "Equilibirium climate sensitivity (C)", "Social cost of methane ($/t-CH4)", c("Aerosol forcing \nscale factor", "Carbon sink respiration \ntemperature sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, FALSE, TRUE)
...
extended_fig_5c = scatter_4way(scatter_data_hectorch4, c("aerosol", "ECS", "Q10_size", "heat_diffusion"), 5000, 21, 0.8, c("blue", "dodgerblue", "cyan", "yellow"), c(2.0, 4.0), c(2.0, 4.0), c("< 2.0", "> 4.0"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,2.03), c(0,0.5,1,1.5,2),  c("0","0.5","1","1.5","2"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), "Aerosol radiative forcing scale factor", "Equilibirium climate sensitivity (C)", c("Ocean heat \ndiffusivity", "Carbon sink respiration \ntemperature sensitivity"), c(6,2,3,3), FALSE, "", "", TRUE, TRUE)
extended_fig_5f = scatter_4way(scatter_data_hectorch4, c("ECS", "dice", "Q10_size", "aerosol"), 5000, 23, 0.9, c("yellow", "red", "blue"), c(0.6, 1.5), c(0.6,1.5), c("< 0.5", "> 1.5"), c(0.5,4.0), c(1.01,2.0,3, 4), c("1", "2", "3", "4+"), c(0,9), c(0,2,4,6,8), c("0","2","4","6","8"), c(0,3600), c(0,1000,2000,3000), c("0","1,000","2,000","3,000"), "Equilibirium climate sensitivity (C)", "Social cost of methane ($/t-CH4)", c("Aerosol forcing \nscale factor", "Carbon sink respiration \ntemperature sensitivity"), c(6,3,3,2), TRUE, c("ECS", "fund", "Q10_size", "aerosol"), 21, TRUE, TRUE)
