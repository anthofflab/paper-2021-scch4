...
#mcmc_data="RF_uncert_NEWrf_hetero_Dec6_wider_init_newch4iceinterp"
   ...
   base_temp               =   Array(Float64, number_samples, number_years);
    ...
    try
        ...
        #marginal_lifech4[:,i]         = sneasy_marginal[:ch4cyclemagicc, :TAU_OH]
            ...
            #Print iteration number with error to track progress.
            println("Model evaluation ", i, " of ", number_samples, " screwed up.")
