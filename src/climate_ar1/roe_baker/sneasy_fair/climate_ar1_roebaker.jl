...
function climate_m(mcmc_data::String, chain_size::String; mean_chain::Bool=false, maxpost_chain::Bool=false, Conf_lvl_1::Float64=0.90, Conf_lvl_2::Float64=0.98)
    ...
    #else
    #    chain = readtable(joinpath("calibration/sneasy_fair/mcmc_results/", mcmc_data, string(chain_size, ".csv")), separator =',', header=true);
    #end
    ...
    for i in 1:number_samples
        ...
        setparameter(sneasy_base, :doeclim, :t2co, RB_ECS_sample[i])
        setparameter(sneasy_marginal, :doeclim, :t2co, RB_ECS_sample[i])
