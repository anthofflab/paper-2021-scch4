...
function climate_h(mcmc_data::String, chain_size::String; mean_chain::Bool=false, maxpost_chain::Bool=false, Conf_lvl_1::Float64=0.90, Conf_lvl_2::Float64=0.98)
   ...
   # EMISSIONS IN UNITS MEGATONNES. ADD 1 TONNE.
    ...
    for i in 1:number_samples
        ...
        N2O_0        = chain[rand_indices[i,24], 24]
        F2x_CO₂      = chain[rand_indices[i,25], 25]
        rf_scale_CH₄ = chain[rand_indices[i,26], 26]
...
output_folder = joinpath("climate_ar1/broken_correlations/sneasy_fair/climate_ar1_results", "NO_NATURAL_EMISS_RF_uncert_NEWrf", rcp_scenario)
