...
#include("src/sneasy_fund/sneasy_fund_oldRF.jl")
...
function climate_f(mcmc_data::String, chain_size::String; mean_chain::Bool=false, maxpost_chain::Bool=false, Conf_lvl_1::Float64=0.90, Conf_lvl_2::Float64=0.98)

    #Read in MCMC results and Emissions Data
    #if mean_chain
    #    chain = readtable(joinpath("calibration/sneasy_fund/mcmc_results/", mcmc_data, "mean_params.csv"), separator =',', header=true);
    #elseif maxpost_chain
    #    chain = readtable(joinpath("calibration/sneasy_fund/mcmc_results/", mcmc_data, "maxpost_params.csv"), separator =',', header=true);
    #else
...
# Filter out non-physical model runs set to -9999.99.
    ...
    if !mean_chain && !maxpost_chain
        ...
        return years, base_temp, base_co2, base_ch4, base_heat_interior, base_oceanco2, marginal_temp, marginal_co2, marginal_ch4, marginal_heat_interior, marginal_oceanco2, conf_base_temp, conf_base_co2, conf_base_ch4, conf_base_heatint, conf_base_oceanco2

    else
        return years, base_temp, base_co2, base_ch4, base_heat_interior, base_oceanco2, marginal_temp, marginal_co2, marginal_ch4, marginal_heat_interior, marginal_oceanco2
    end
