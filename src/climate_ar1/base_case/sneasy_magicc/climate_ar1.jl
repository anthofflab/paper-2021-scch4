...
#include("src/sneasy_magicc/sneasy_magicc_oldRF.jl")
include("src/sneasy_magicc/sneasy_magicc.jl")
...
=#
        ...
        #= if !mean_chain && !maxpost_chain
            ar1_temp      = ar1_sim(number_years, ρ_temp, σ_temp)
            ar1_co2       = ar1_sim(number_years, ρ_co2inst, σ_co2inst)
            # Start year to 1983 (NOAA flask data starts in 1984).
            ar1_ch4       = double_ar1_sim(length(start_year:1983), ρ_ch4ice, σ_ch4ice, length(1984:end_year), ρ_ch4inst, σ_ch4inst)
            ar1_heat      = ar1_sim(number_years, ρ_ocheat, σ_ocheat)
